...
## Agenda 
  ...
  1. Kubernetes Debugging
     ...
     * [Übung: CrashLoopBackOff, aber die Logs sind sauber - OOMKilled (137) und Completed (0) ueber Exit Codes finden](kubectl-examples/24-debug-crashloop-exitcodes.md)
